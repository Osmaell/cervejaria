...
public class ClassForErrorAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	private static final String NOME_TAG = "classforerror";
	private static final int PRECEDENCIA = 1000;

	public ClassForErrorAttributeTagProcessor(String dialectPrefix) {
		super(TemplateMode.HTML, dialectPrefix, null, false, NOME_TAG, true, PRECEDENCIA, true );
	}
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, AttributeName attributeName,
		...
		if(temErro) {
			String todasClasses = tag.getAttributeValue("class");
			structureHandler.setAttribute("class", todasClasses + " has-error");
		}
