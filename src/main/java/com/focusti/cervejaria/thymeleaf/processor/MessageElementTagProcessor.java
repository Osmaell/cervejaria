...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag, IElementTagStructureHandler structureHandler) {
		...
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace", "layout/MensagensErro :: mensagens-erro"));
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace" ,"layout/MensagemSucesso :: mensagem-sucesso"));
