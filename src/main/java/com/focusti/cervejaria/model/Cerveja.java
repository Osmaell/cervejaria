...
public class Cerveja implements Serializable {
	...
	@Size(min = 3, max = 50, message = "O tamanho da descrição deve conter entre 3 e 50 caracteres")
	private String descricao;

	@NotNull(message = "O valor é obrigatório")
	@DecimalMin("0.50")
	@DecimalMax(value = "9999", message = "O valor da cerveja deve ser menor que R$9.999")
