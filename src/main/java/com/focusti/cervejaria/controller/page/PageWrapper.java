package com.focusti.cervejaria.controller.page;
...
public class PageWrapper<T> {
	...
	// responsável por construir a uri
	...
	public String urlOrdenada(String propriedade) {
		...
		// criando uma nova URI, pois caso for utilizado a variável uriBuilder,
		// vai alterar a url gerada na paginação mesmo termos ordenado.
